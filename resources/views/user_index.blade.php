            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <a style="color:white; float:right;" class="btn btn-info" href="{{ URL::route('user_create') }}">ADD USER</a>

                        <button type="submit" id="user_show" style="color:black;font-family: Arial" class="btn btn-small btn-success" onClick="user_show()";> <i class="glyphicon glyphicon-align-justify"></i> Show </button> 
                        <button type="submit" id="user_edit" style="color:black;font-family: Arial" class="btn btn-small btn-info" onClick="user_edit()";> <i class="glyphicon glyphicon-edit"></i> Edit </button> 
                        <button type="submit" id="user_delete" style="color:black; font-family: Arial" class="btn btn-small btn-danger" onClick="user_delete()";> <i class="glyphicon glyphicon-trash"></i> Delete </button> 
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr style="text-align: center;">
                            <td><input type="checkbox" name="selected_user[]" value="{{ $value->id }}" id="selected_user" class="select_checkbox"></td>
                            <td><?php echo $no ?></td>
                            <td>{{ $value->name }}</td>
                            <td>{{ $value->email }}</td>
                        </tr>
