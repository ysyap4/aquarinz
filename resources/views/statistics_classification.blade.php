                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                        <tr style="text-align: center;">
                            ...
                            @foreach($phylum as $value) <td> {{ $value->phylum_name }} </td> @endforeach
                        </tr>
                        <tr style="text-align: center;">
                             <th style="text-align: center;"> Number </th>
                            @foreach($phylum_count as $count) <td> {{ $count->order_count }} </td> @endforeach
                        </tr>
                    </tbody>
                    </table>
                    ...
                    <tbody>
                        <tr style="text-align: center;">
                            ...
                            @foreach($class as $value) <td> {{ $value->class_name }} </td> @endforeach
                        </tr>
                        <tr style="text-align: center;">
                             <th style="text-align: center;"> Number </th>
                            @foreach($class_count as $count) <td> {{ $count->order_count }} </td> @endforeach
                        </tr>
                    </tbody>
                    </table>
                        </div>
