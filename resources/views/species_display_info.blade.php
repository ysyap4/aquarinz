            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Search species by scientific name</h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <h2> Scientific Name: 
                            <a href="{{ URL::route('species_display_info', array($species->id)) }}">
                                {{ $species->scientific_name }}
                            </a>
                        </h2>

                        <h2> Common Name: {{ $species->common_name }}</h2>

                        <br>
                        <h2> Classification </h2>
                        <h2> Phylum: 
                            <a href="{{ URL::route('species_classification_display_species', array($species->phylum)) }}"> 
                                {{ $species->phylum }}
                            </a>
                        </h2>
                        <h2> Class: 
                            <a href="{{ URL::route('species_classification_display_species', array($species->class)) }}"> 
                                {{ $species->class }}
                            </a>
                        </h2>
                        <h2> Family: 
                            <a href="{{ URL::route('species_classification_display_species', array($species->family)) }}">
                                {{ $species->family }}
                            </a>
                        </h2>
                        <h2> Genus: 
                            <a href="{{ URL::route('species_classification_display_species', array($species->genus)) }}">
                                {{ $species->genus }}
                            </a>
                        </h2>
                        <br>
                        <h2> Size: {{ $species->size }} </h2>
                        <h2> Habitat: {{ $species->habitat }} </h2>
                        <h2> Life History: {{ $species->life_history }} </h2>
